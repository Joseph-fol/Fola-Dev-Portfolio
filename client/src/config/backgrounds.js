const LIGHT_THEME = {
  textPrimary: '#17355f',
  textSecondary: '#587397',
  surface: 'rgba(238, 247, 255, 0.78)',
  surfaceStrong: 'rgba(255, 255, 255, 0.9)',
  surfaceBorder: 'rgba(255, 255, 255, 0.88)',
  surfaceMuted: 'rgba(255, 255, 255, 0.4)',
  shadow: 'rgba(64, 106, 154, 0.12)',
  accentSurface: 'rgba(26, 110, 245, 0.14)',
};

const DARK_THEME = {
  textPrimary: '#f4f8ff',
  textSecondary: 'rgba(232, 241, 255, 0.72)',
  surface: 'rgba(8, 14, 28, 0.42)',
  surfaceStrong: 'rgba(10, 18, 34, 0.72)',
  surfaceBorder: 'rgba(255, 255, 255, 0.14)',
  surfaceMuted: 'rgba(255, 255, 255, 0.12)',
  shadow: 'rgba(1, 6, 18, 0.35)',
  accentSurface: 'rgba(255, 255, 255, 0.12)',
};
